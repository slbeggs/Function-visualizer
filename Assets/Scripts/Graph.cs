...
public class Graph : MonoBehaviour
{
    ...
    */
    ...
    private void OnGUI()
    {
        function = (GraphFunctionName)GUI.SelectionGrid(
            new Rect(10, 200, 200, 200), // Position and size of the GUI element
            (int)function,
            Enum.GetNames(typeof(GraphFunctionName)),1); // Number of columns in the grid
    }
